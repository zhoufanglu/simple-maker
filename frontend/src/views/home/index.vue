    ...
    <n-spin :show="downloadLoading">
      ...
      <div ref="previewBoxRef" class="preview-box">
        ...
        <div class="container">
          ...
          <choose-images v-show="homeStore.modeType === 'edit'" ref="chooseImagesRef"
            @handle-image-box-height-change="handleImageBoxHeightChange"></choose-images>
          <div class="pin-box" :style="{
